...
<body class="bg-gradient-to-br from-orange-100 to-orange-300 min-h-screen flex
items-center justify-center">
<div class="bg-white shadow-lg rounded-lg p-8 w-full max-w-md">
<h2 class="text-2xl font-bold text-center text-orange-700 mb-6">Login
Administrator</h2>
...
focus:ring-blue-500 focus:border-orange-500">
</div>
<div>
...
focus:ring-orang-500 focus:border-orange-500">
</div>
