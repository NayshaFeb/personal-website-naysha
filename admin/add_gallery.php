...
<h2 class="text-xl font-semibold text-orange-700 mb-4 text-
center">MENU</h2>
...
<li>
<a href="logout.php" onclick="return confirm('Apakah anda yakin  t  ingin keluar?');"
...
class="bg-orange-700 text-white px-4 py-2 rounded hover:bg-blue-
800 transition">Simpan</button>

<a href="data_gallery.php"

class="bg-orange-300 text-orange-700 px-4 py-2 rounded hover:bg-
