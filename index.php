...
Personal Web | Naysha febriyana
</header>
<!-- Navigation -->
<nav class="bg-orange-600 text-white py-3">
...
mt-6">
<!-- Artikel Utama -->
<section class="md:col-span-2 bg-orange-200 p-6 rounded shadow">
...
<!-- Sidebar -->
<aside class="bg-orange-200 p-6 rounded shadow">
...
<!-- Footer -->
<footer class="bg-orange-900 text-white text-center py-4 mt-10">
